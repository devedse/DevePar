...
namespace DevePar.LinearAlgebra
{
    public class MatrixGFieldFast
    {
        ...
        public GFTable GFTable { get; }

        private MatrixGFieldFast(GFTable gfTable, int rows, int columns)
        {
            GFTable = gfTable;
            this.Rows = rows;
            this.Columns = columns;
            Data = new ushort[rows][];
            for (int i = 0; i < rows; i++)
            {
                Data[i] = new ushort[columns];
            }
        }

        public MatrixGFieldFast(GFTable gfTable, int rows, int columns, ushort value) : this(gfTable, rows, columns)
        {
            for (int i = 0; i < rows; i++)
            {
                Data[i][i] = value;
        ...
        public MatrixGFieldFast(GFTable gfTable, ushort[][] value)
        {
            GFTable = gfTable;
        ...
        //public MatrixGFieldFast(GField[,] value) : this(value.GetLength(0), value.GetLength(1))
        //{
        //    for (int i = 0; i < Rows; i++)
        //    {
        ...
        //public MatrixGFieldFast(GFTable table, uint[,] value) : this(value.GetLength(0), value.GetLength(1))
        //{
        //    for (int i = 0; i < Rows; i++)
        //    {
        //        for (int y = 0; y < Columns; y++)
        ...
        public static MatrixGFieldFast CreateIdentityMatrix(GFTable table, int size)
        {
            var values = new ushort[size][];
            for (int i = 0; i < size; i++)
            {
                values[i] = new ushort[size];
            }
            ...
            return new MatrixGFieldFast(table, values);
        }

        public override bool Equals(object obj)
        {
            return Equals(this, (MatrixGFieldFast)obj);
        }

        public static bool Equals(MatrixGFieldFast left, MatrixGFieldFast right)
        {
        ...
        public MatrixGFieldFast Submatrix(int startRow, int endRow, int startColumn, int endColumn)
        {
            ...
            var X = new MatrixGFieldFast(GFTable, endRow - startRow + 1, endColumn - startColumn + 1);
            var x = X.Data;
        ...
        public MatrixGFieldFast Submatrix(int[] rowIndexes, int[] columnIndexes)
        {
            var X = new MatrixGFieldFast(GFTable, rowIndexes.Length, columnIndexes.Length);
            var x = X.Data;
        ...
        public MatrixGFieldFast Submatrix(int i0, int i1, int[] c)
        {
            ...
            var X = new MatrixGFieldFast(GFTable, i1 - i0 + 1, c.Length);
            var x = X.Data;
            for (int i = i0; i <= i1; i++)
            {
        ...
        public MatrixGFieldFast Submatrix(int[] r, int j0, int j1)
        {
            ...
            var X = new MatrixGFieldFast(GFTable, r.Length, j1 - j0 + 1);
            var x = X.Data;
        ...
        public MatrixGFieldFast AddRowsAtTheEnd(MatrixGFieldFast right)
        {
            ...
            return new MatrixGFieldFast(GFTable, newMatrixRows);
        }

        /// <summary>Creates a copy of the matrix.</summary>
        public MatrixGFieldFast Clone()
        {
            var X = new MatrixGFieldFast(GFTable, Rows, Columns);
            var x = X.Data;
            for (int i = 0; i < Rows; i++)
            {
        ...
        public MatrixGFieldFast Transpose()
        {
            var X = new MatrixGFieldFast(GFTable, Columns, Rows);
            var x = X.Data;
            for (int i = 0; i < Rows; i++)
            {
                for (int j = 0; j < Columns; j++)
        ...
        public static void ThrowIfLeftOrRightIsNull(MatrixGFieldFast left, MatrixGFieldFast right)
        {
            if (left == null)
            {
        ...
        public static void ThrowIfLeftOrRightNotSameGFTable(MatrixGFieldFast left, MatrixGFieldFast right)
        {
            if (left.GFTable != right.GFTable && left.GFTable != null)
            {
                throw new ArgumentException("GFTable should be equal for Left and Right");
            }
        }

        /// <summary>Matrix equality.</summary>
        public static bool operator ==(MatrixGFieldFast left, MatrixGFieldFast right)
        {
        ...
        public static MatrixGFieldFast Add(MatrixGFieldFast left, MatrixGFieldFast right)
        {
            ThrowIfLeftOrRightIsNull(left, right);
            ThrowIfLeftOrRightNotSameGFTable(left, right);
            ...
            var X = new MatrixGFieldFast(left.GFTable, rows, columns);
            var x = X.Data;
            for (int i = 0; i < rows; i++)
            {
                for (int j = 0; j < columns; j++)
                {
                    x[i][j] = (ushort)left.GFTable.Add(data[i][j], right[i, j]);
                }
            }
            return X;
        }
        ...
        /// <summary>Matrix addition.</summary>
        public static MatrixGFieldFast operator +(MatrixGFieldFast left, MatrixGFieldFast right)
        {
            return Add(left, right);
        }

        /// <summary>Matrix subtraction.</summary>
        public static MatrixGFieldFast Subtract(MatrixGFieldFast left, MatrixGFieldFast right)
        {
            ThrowIfLeftOrRightIsNull(left, right);
            ...
            for (int i = 0; i < rows; i++)
            {
                for (int j = 0; j < columns; j++)
                {
                    x[i][j] = (ushort)left.GFTable.Sub(data[i][j], right[i, j]);
                }
            }
            return X;
        }
        ...
        public static MatrixGFieldFast Multiply(MatrixGFieldFast left, ushort right)
        {
            if (left == null)
            {
                throw new ArgumentNullException("left");
            ...
            for (int i = 0; i < rows; i++)
            {
                for (int j = 0; j < columns; j++)
                {
                    x[i][j] = (ushort)left.GFTable.Mul(data[i][j], right);
                }
            }
        ...
        /// <summary>Matrix-scalar multiplication.</summary>
        public static MatrixGFieldFast operator *(MatrixGFieldFast left, ushort right)
        {
            return Multiply(left, right);
        }

        /// <summary>Matrix-matrix multiplication.</summary>
        public static MatrixGFieldFast Multiply(MatrixGFieldFast left, MatrixGFieldFast right)
        {
            ThrowIfLeftOrRightIsNull(left, right);
            ...
            for (int j = 0; j < columns; j++)
            {
                ...
                {
                    var row = data[i];
                    var s = left.GFTable.Mul(row[0], column[0]);
                    for (int k = 1; k < size; k++)
                    {
                        s = left.GFTable.Add(s, left.GFTable.Mul(row[k], column[k]));
                    }
                    x[i][j] = (ushort)s;
                }
            }
        ...
        public static MatrixGFieldFast Random(Random random, GFTable table, int rows, int columns)
        {
            int size = (int)table.Size;
            var X = new MatrixGFieldFast(table, rows, columns);
            var x = X.Data;
            for (int i = 0; i < rows; i++)
            {
                for (int j = 0; j < columns; j++)
                {
                    x[i][j] = (ushort)random.Next(size);
                }
            }
            return X;
        }
        ...
        public static MatrixGFieldFast Diagonal(GFTable table, int rows, int columns, ushort value)
        {
            var X = new MatrixGFieldFast(table, rows, columns);
            var x = X.Data;
            for (int i = 0; i < rows; i++)
        ...
        public ushort[] Multiply(ushort[] right)
        {
            ...
            var newData = new ushort[this.Rows];
            for (int i = 0; i < this.Rows; i++)
            {
                var result = GFTable.Mul(Data[i][0], right[0]);
                for (int y = 1; y < this.Columns; y++)
                {
                    result = GFTable.Add(result, GFTable.Mul(Data[i][y], right[y]));
                }
                newData[i] = (ushort)result;
            }
